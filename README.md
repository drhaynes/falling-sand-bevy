...
* small example ["game"](https://niklasei.github.io/falling_sand_game_template/) (*warning: biased; e.g., split into a lot of plugins and using `bevy_kira_audio` for sound*)
